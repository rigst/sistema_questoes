...
urlpatterns = [
    ...
    path(
        "disciplina/<int:pk>/renomear-inline/",
        views.disciplina_renomear_inline,
        name="disciplina_renomear_inline",
    ),
    path(
        "disciplina/<int:pk>/excluir-inline/",
        views.disciplina_excluir_inline,
        name="disciplina_excluir_inline",
    ),
]

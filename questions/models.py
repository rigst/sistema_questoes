...
class ImportacaoPDF(models.Model):
    ...
    disciplina = models.ForeignKey(Disciplina, on_delete=models.CASCADE, related_name="importacoes")
...
class Questao(models.Model):
    ...
    disciplina = models.ForeignKey(Disciplina, on_delete=models.CASCADE, related_name="questoes")
...
class LeituraTopico(models.Model):
    ...
    topico = models.ForeignKey(Topico, on_delete=models.CASCADE, related_name="leituras")
